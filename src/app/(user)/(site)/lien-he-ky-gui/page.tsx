      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-16 text-center">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="text-4xl font-light tracking-tighter text-neutral-900 xl:text-5xl">
              Ký gửi <span className="font-extralight italic text-neutral-400">Bất động sản</span>
            </h1>
        ...
        <div className="mx-auto max-w-3xl bg-white pb-24">
          <form className="space-y-12">
            ...
            <section>
              <h2 className="mb-8 border-l-4 border-neutral-900 pl-4 text-lg font-medium tracking-tight">01. Thông tin liên hệ</h2>
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div>
                  <FormLabel title="Họ và tên chủ sở hữu" required />
                  <input type="text" className={FormInputClass} />
                </div>
                <div>
                  <FormLabel title="Số điện thoại / Zalo" required />
                  <input type="tel" className={FormInputClass} />
                </div>
              </div>
            </section>
            ...
            <section>
              <h2 className="mb-8 border-l-4 border-neutral-900 pl-4 text-lg font-medium tracking-tight">02. Chi tiết tài sản</h2>
              <div className="space-y-8">
                <div>
                  <FormLabel title="Địa chỉ chi tiết" required />
                  <input type="text" placeholder="Số nhà, tên đường, phường, tỉnh..." className={FormInputClass} />
                </div>
            ...
            <section>
              <h2 className="mb-8 border-l-4 border-neutral-900 pl-4 text-lg font-medium tracking-tight">03. Hình ảnh & Pháp lý</h2>
