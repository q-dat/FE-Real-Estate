...
export default function RentalFavoritesPage() {
  ...
  if (favorites.length === 0)
    return (
      <div className="pt-mobile-padding-top xl:pt-desktop-padding-top h-screen px-2 text-center text-black xl:px-desktop-padding">
  ...
  return (
    <div className="pt-mobile-padding-top xl:pt-desktop-padding-top h-screen px-2 text-black xl:px-desktop-padding">
