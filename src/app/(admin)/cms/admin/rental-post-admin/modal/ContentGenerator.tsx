...
export default function ContentGeneratorModal({ open, onClose }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-[999999] flex items-center justify-center bg-slate-950/80 p-3 backdrop-blur-xl">
            <div className="flex h-[90dvh] w-[98vw] flex-col overflow-hidden rounded-[1.5rem] border border-slate-700/70 bg-slate-950 text-slate-100 shadow-2xl">
                <div className="flex shrink-0 items-center justify-between border-b border-slate-800 bg-slate-950 px-5 py-4">
                    <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                            <h2 className="truncate text-[15px] font-black uppercase tracking-[0.18em] text-slate-100">
                                Workspace Editor
                            </h2>
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-xs font-medium text-red-200/70">
                                    Chỉ dùng khi cần xoá toàn bộ tab đã lưu và trạng thái Done/Pending.
                                </p>
                            </div>
                ...
                {error && (
                    <div className="shrink-0 border-b border-amber-400/20 bg-amber-950/40 px-5 py-2 text-sm font-semibold text-amber-200">
                        {error}
                    </div>
                )}
                    ...
                    >
                            ...
                            {isJsonPanelExpanded ? (
                                <div>
                                    ...
                                    <p className="mt-1 text-[11px] text-slate-600">
                                        Hover để mở, rời chuột tự thu nếu chưa ghim.
                                    </p>
                                </div>
                            ) : null}
                        ...
                        {isJsonPanelExpanded ? (
                            <div className="flex min-h-0 flex-1 flex-col gap-3 p-4">
                                ...
                                <div className="flex min-h-0 flex-1 flex-col">
                                    ...
                                    <textarea
                                        ...
                                        spellCheck={false}
                                        className="min-h-0 flex-1 resize-none overflow-auto whitespace-pre-wrap break-words rounded-xl border border-slate-700/80 bg-slate-900/70 p-4 font-mono text-[12px] leading-relaxed text-slate-200 outline-none transition placeholder:text-slate-600 hover:border-cyan-400/30 focus:border-cyan-400/60 focus:bg-slate-950 focus:ring-4 focus:ring-cyan-400/10  [scrollbar-width:thin]"
                                    />
                                </div>
                            ...
                            <div className="flex flex-1 items-center justify-center">
                                <p className="-rotate-90 whitespace-nowrap text-[10px] font-black uppercase tracking-[0.35em] text-slate-600">
                                    JSON Import
                                </p>
                            </div>
                        )}
                                    ...
                                    {parsedData.map((item, index) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`group flex min-w-[180px] items-center justify-between gap-2 rounded-t-xl border-x border-t px-3 py-2 text-left text-[11px] font-black transition ${isActive
                                            ...
                                            >
                                                ...
                                                <span
                                                    className={`rounded-full px-2 py-0.5 text-[9px] uppercase ${status === 'done'
                                            ...
                                            <div className="mb-5 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
                                                <div className="min-w-0">
                                                    ...
                                                    <h3 className="mt-1 line-clamp-2 break-words text-lg font-black text-slate-100">
                                                        {activeItem.title || 'Chưa có tiêu đề'}
                                                    </h3>
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    className={`rounded-xl border px-4 py-2 text-xs font-black uppercase tracking-wide transition ${(tabStatuses[activeItem._tempId] || 'pending') === 'done'
                                                ...
                                                <div className="mb-3 flex items-center justify-between gap-3">
                                                    <div>
                                                        ...
                                                        <p className="mt-1 text-xs text-slate-600">
                                                            Đã bật xuống dòng tự nhiên để dễ rà soát dữ liệu dài.
                                                        </p>
                                                    </div>

                                                    {renderCopyButton('system-json', systemJsonText)}
                                                </div>
