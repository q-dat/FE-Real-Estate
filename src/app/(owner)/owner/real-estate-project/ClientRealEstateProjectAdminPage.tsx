...
export default function ClientRealEstateProjectAdminPage({ projects: initial }: Props) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FCFCFC]">
      ...
      <div className="sticky top-0 flex flex-col gap-4 border-b border-neutral-200/60 bg-[#FCFCFC]/80 px-4 pb-5 pt-6 backdrop-blur-xl sm:px-6 md:flex-row md:items-end md:justify-between xl:px-8">
        <div>
