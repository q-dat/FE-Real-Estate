          ...
          {projects.map((p) => (
            ...
            >
              ...
              <div className="relative aspect-[16/10] overflow-hidden">
                ...
                {/* Status */}
                {p.status && (
                  <span className="absolute left-5 top-5 rounded-full border border-white/30 bg-overlay px-4 py-1 text-xs font-light tracking-wide text-white backdrop-blur">
                    {p.status}
                  </span>
                )}
              </div>
